      ...
      <View style={this.props.buttonWrapStyle} >
        <TouchableOpacity
          style={[
            ...
            {borderColor:this.state.buttonOuterColor},
          ...
          <View style={[
            ...
            this.props.isSelected && {backgroundColor:this.state.buttonColor},
            this.props.isSelected && {backgroundColor:this.state.buttonInnerColor}
          ]}></View>
        </TouchableOpacity>
      </View>
    )
